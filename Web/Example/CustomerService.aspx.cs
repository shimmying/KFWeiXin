...
namespace KFWeiXinWeb.Example
{
    public partial class CustomerService : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            ErrorMessage errorMessage = KFWeiXin.PublicAccount.CustomerService.CustomerService.Add(userName, txtAccount.Text, txtNickname.Text, txtPassword.Text);
        ...
        protected void btnGetKfList_Click(object sender, EventArgs e)
        {
            ...
            List<CustomerServiceAccount> kfList = KFWeiXin.PublicAccount.CustomerService.CustomerService.GetKfList(userName, out errorMessage);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (lbKfList.Items != null && lbKfList.SelectedIndex >= 0)
            {
                ...
                ErrorMessage errorMessage = KFWeiXin.PublicAccount.CustomerService.CustomerService.Update(userName, kfAccount, txtNickname2.Text, txtPassword2.Text);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            if (lbKfList.Items != null && lbKfList.SelectedIndex >= 0)
            {
                string userName = lbPublicAccount.SelectedValue;
                string kfAccount = lbKfList.SelectedValue;
                ErrorMessage errorMessage = KFWeiXin.PublicAccount.CustomerService.CustomerService.Delete(userName, kfAccount);
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (lbKfList.Items != null && lbKfList.SelectedIndex >= 0)
            {
                string userName = lbPublicAccount.SelectedValue;
                string kfAccount = lbKfList.SelectedValue;
                ErrorMessage errorMessage = KFWeiXin.PublicAccount.CustomerService.CustomerService.UploadHeadImage(userName, kfAccount, fileUpload.FileBytes);
        ...
        protected void btnGetOnlineKfList_Click(object sender, EventArgs e)
        {
            ...
            string userName = lbPublicAccount.SelectedValue;
            ErrorMessage errorMessage;
            List<CustomerServiceOnlineInfo> onlineList = KFWeiXin.PublicAccount.CustomerService.CustomerService.GetOnlineKfList(userName, out errorMessage);
            if (errorMessage.IsSuccess)
            {
        ...
        protected void btnGetWaitCase_Click(object sender, EventArgs e)
        {
            ...
            ErrorMessage errorMessage;
            string userName = lbPublicAccount.SelectedValue;
            WaitCaseSession sessions = KFWeiXin.PublicAccount.CustomerService.CustomerService.GetWaitCase(userName, out errorMessage);
            if (errorMessage.IsSuccess)
            {
                if (sessions != null)
                {
        ...
        protected void lbCreateSession_Click(object sender, EventArgs e)
        {
            ...
            ErrorMessage errorMessage = KFWeiXin.PublicAccount.CustomerService.CustomerService.Create(userName, openId, kfAccount);
        ...
        protected void btnGetSessionList_Click(object sender, EventArgs e)
        {
            ...
            string kfAccount = lbOnlineKfList.SelectedIndex >= 0 ? lbOnlineKfList.SelectedValue : "";
            ErrorMessage errorMessage;
            CustomerServiceSession[] sessions = KFWeiXin.PublicAccount.CustomerService.CustomerService.GetSessionList(userName, kfAccount, out errorMessage);
            if (errorMessage.IsSuccess)
            {
        ...
        protected void btnGetSession_Click(object sender, EventArgs e)
        {
            ...
            ErrorMessage errorMessage;
            CustomerSession session = KFWeiXin.PublicAccount.CustomerService.CustomerService.GetSession(userName, openId, out errorMessage);
            if (errorMessage.IsSuccess)
        ...
        protected void btnCloseSession_Click(object sender, EventArgs e)
        {
            ...
            string openId = lbSession.SelectedIndex >= 0 ? lbSession.SelectedValue : "";
            string kfAccount = lbOnlineKfList.SelectedIndex >= 0 ? lbOnlineKfList.SelectedValue : "";
            ErrorMessage errorMessage = KFWeiXin.PublicAccount.CustomerService.CustomerService.Close(userName, openId, kfAccount);
