...
using KFWeiXin.PublicAccount.TemplateMessage;
using KFWeiXin.PublicAccount.UserManagement;

namespace KFWeiXinWeb.Example
{
    public partial class TemplateMessage : System.Web.UI.Page
    {
        ...
        protected void btnSetIndustry_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorMessage errorMessage = KFWeiXin.PublicAccount.TemplateMessage.TemplateMessage.SetIndustry(userName, industryCode1, industryCode2);
        ...
        protected void btnGetTemplateId_Click(object sender, EventArgs e)
        {
            ...
            string templateId = KFWeiXin.PublicAccount.TemplateMessage.TemplateMessage.GetId(userName, txtTemplateIdShort.Text, out errorMessage);
        ...
        protected void btnGetTemplates_Click(object sender, EventArgs e)
        {
            ...
            Template[] templates = KFWeiXin.PublicAccount.TemplateMessage.TemplateMessage.GetAllPrivateTemplates(userName, out errorMessage);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            if (rblTemplates.SelectedIndex >= 0)
            {
                ...
                if (KFWeiXin.PublicAccount.TemplateMessage.TemplateMessage.Delete(userName, templateId, out errorMessage))
                {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            if (rblUser.SelectedIndex >= 0 && rblTemplates.SelectedIndex > 0)
            {
                ...
                ErrorMessage errorMessage;
                long msgId = KFWeiXin.PublicAccount.TemplateMessage.TemplateMessage.Send(userName, rblUser.SelectedValue, templateId, "", Color.Black, data, out errorMessage);
                if (errorMessage.IsSuccess)
